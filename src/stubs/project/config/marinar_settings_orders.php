...
return [
     ...
     */
    'install_behavior' => env('MARINAR_SETTINGS_ORDERS_INSTALL_BEHAVIOR', env('MARINAR_INSTALL_BEHAVIOR', true)),
     ...
     * 2 - keep everything
     */
    'delete_behavior' => env('MARINAR_SETTINGS_ORDERS_DELETE_BEHAVIOR', env('MARINAR_DELETE_BEHAVIOR', false)),
